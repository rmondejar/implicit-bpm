    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="createdDate"
                              title="${message(code: 'book.createdDate.label', default: 'Created Date')}"/>

            <g:sortableColumn property="amount" title="${message(code: 'book.amount.label', default: 'Amount')}"/>
        ...
        <g:each in="${bookInstanceList}" status="i" var="bookInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${bookInstance.id}">${fieldValue(bean: bookInstance, field: "createdDate")}</g:link></td>

                <td>${fieldValue(bean: bookInstance, field: "amount")}</td>
