...
<head>
    ...
    <title><g:message code="default.edit.label" args="[entityName]" />  ${deployUnitInstance.toString()}</title>
</head>
<body>
...
<div id="edit-deployUnit" class="content scaffold-edit" role="main">
    ...
    <g:hasErrors bean="${deployUnitInstance}">
        <ul class="errors" role="alert">
            <g:eachError bean="${deployUnitInstance}" var="error">
    ...
    <g:hiddenField name="version" value="${deployUnitInstance?.version}" />
    <fieldset class="form">
