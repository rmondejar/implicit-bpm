...
<html>
	...
	<body>
		<a href="#edit-remoteApp" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-remoteApp" class="content scaffold-edit" role="main">
			...
			<g:form class="form-horizontal" method="post" >
				...
				<g:hiddenField name="version" value="${remoteAppInstance?.version}" />
				<fieldset class="form">
