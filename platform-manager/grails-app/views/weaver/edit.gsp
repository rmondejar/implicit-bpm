...
<head>
    ...
    <title><g:message code="default.edit.label" args="[entityName]" />  ${weaverInstance.toString()}</title>
</head>
<body>
...
<div id="edit-weaver" class="content scaffold-edit" role="main">
    ...
    <g:hasErrors bean="${weaverInstance}">
        <ul class="errors" role="alert">
            <g:eachError bean="${weaverInstance}" var="error">
    ...
    <g:hiddenField name="version" value="${weaverInstance?.version}" />
    <fieldset class="form">
